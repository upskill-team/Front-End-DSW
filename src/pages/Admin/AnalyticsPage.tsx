      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            >
              {analytics.growth.professorsGrowthPercentage >= 0 ? '+' : ''}
              {analytics.growth.professorsGrowthPercentage.toFixed(1)}% este mes
            </p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Estado actual de todos los cursos</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
            ...
            <div className="mt-4 space-y-2">
              ...
              {analytics.courseStats.averagePriceInCents && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {formatCurrency(analytics.courseStats.averagePriceInCents)}
                  </span>
                </div>
              )}
            </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-sm text-slate-600 mt-1">Cursos esta semana</p>
            </div>
