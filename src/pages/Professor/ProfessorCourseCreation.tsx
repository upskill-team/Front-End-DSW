...
const CourseSchema = v.pipe(
  ...
  v.forward(
    v.check(
      (input) =>
        !input.isFree ? input.price !== undefined && input.price >= 0 : true,
...
export default function ProfessorCourseCreation() {
  ...
  const { data: managedInstitution = null, isLoading: isLoadingInstitution } =
  ...
  const onSubmit = (formData: CourseFormValues) => {
    ...
    dataToSend.append(
      'useInstitution',
      formData.useInstitution ? 'true' : 'false'
    );
            ...
            <CardContent className="space-y-6">
              ...
              {isLoadingInstitution ? (
                ...
                <div className="space-y-4 rounded-lg border p-4">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="useInstitution">
                      ¿Asociar a su intitucion?
                    </Label>
                    <Switch
                      id="useInstitution"
              ...
              <div className="space-y-4 rounded-lg border p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="is-free" {...register('isFree')} />
                </div>
          ...
          <div className="space-y-4">
            ...
            <CoursePreviewCard
              ...
              courseType={courseTypes.find(
                (ct) => ct.id === watchedValues.courseTypeId
              )}
              hideButton
            />
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-sm text-blue-700">
                ...
                tu curso en el dashboard. Una vez creado, podrás agregar
                contenido.
              </p>
            </div>
          </div>
