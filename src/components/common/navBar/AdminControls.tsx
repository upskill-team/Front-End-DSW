    ...
    <>
      <Link
        ...
        className={`px-3 py-1.5 text-sm font-medium rounded-md flex items-center transition-colors ${
          location?.pathname.startsWith("/admin/dashboard") ? activeLinkClasses : inactiveLinkClasses
        }`}
      >
      ...
      <Link
        ...
        className={`px-3 py-1.5 text-sm font-medium rounded-md flex items-center transition-colors ${
          location?.pathname.startsWith("/admin/analytics") ? activeLinkClasses : inactiveLinkClasses
        }`}
      >
      ...
      <Link
        ...
        className={`px-3 py-1.5 text-sm font-medium rounded-md flex items-center transition-colors ${
          location?.pathname.startsWith("/admin/courseTypes") ? activeLinkClasses : inactiveLinkClasses
        }`}
      >
      ...
      <Link
        ...
        className={`px-3 py-1.5 text-sm font-medium rounded-md flex items-center transition-colors ${
          location?.pathname.startsWith("/admin/appeals") ? activeLinkClasses : inactiveLinkClasses
        }`}
      >
